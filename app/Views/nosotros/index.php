        ...
        <div class="row">
            ...
            <div class="col-md-12 section-box">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center">
                        <img src="resources/img/mantenimiento.jpg" alt="Imagen de objetivos" class="img-fluid rounded shadow">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 section-box">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center">
                        <img src="resources/img/valores.jpg" alt="Imagen de valores" class="img-fluid rounded shadow">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 section-box">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center">
                        <img src="resources/img/vision.jpg" alt="Imagen de visión" class="img-fluid rounded shadow">
                    </div>
                </div>
            </div>
        </div>
